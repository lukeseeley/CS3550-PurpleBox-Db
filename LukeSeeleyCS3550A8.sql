...
EXECUTE usp_addMovieRental @userFirstName = 'Waldo', @userLastName = 'Wildcat', @title = 'Incredibles 2', @copyNumber = '2', @movieType = 'D';
EXECUTE usp_addMovieRental @userFirstName = 'Meme', @userLastName = 'Lord', @title = 'The Avengers', @copyNumber = '1', @movieType = 'D';
EXECUTE usp_addMovieRental @userFirstName = 'Luke', @userLastName = 'Seeley', @title = 'Deadpool', @copyNumber = '1', @movieType = 'B';
